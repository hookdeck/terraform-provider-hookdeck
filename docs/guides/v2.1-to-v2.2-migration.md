...
- Legacy fields produce actionable migration errors during planning, including unchanged configurations.

## Troubleshooting

### Destination Config Migration Required

If planning reports `Destination config migration required`, the configuration still contains a retired field. To resolve it:
